...
Public Class Převody_jednotek
    ...
    Private Sub kontrola_textboxů()
        ...
        Try
            ...
            End If
        Catch ex As Exception
            MsgBox("Wrong data about lenght.", MsgBoxStyle.Exclamation)
            chyba = True
        End Try
    ...
    Private Sub zápis_výsledků()
        ...
        label_kmh.Text = "Velocity: " & Round(Val(základní_jednotka_rychlost * 3.6), zaokrouhleni) & " km/h (kilomters per hour)"
        ...
        label_ounce.Text = "Weight: " & Round(Val(základní_jednotka_hmotnost * 35.273961980686721), zaokrouhleni) & " oz (ounce)"
        'Délka
        label_mm.Text = "Lenght: " & Round(Val(základní_jednotka_délka * 1000), zaokrouhleni) & " mm (milimeters)"
        label_inch.Text = "Lenght: " & Round(Val(základní_jednotka_délka * 39.370078740157481), zaokrouhleni) & " in (inches)"
        label_m.Text = "Lenght: " & Round(Val(základní_jednotka_délka * 1), zaokrouhleni) & " m (meters)"
        label_ft.Text = "Lenght: " & Round(Val(základní_jednotka_délka * 3.2808398950131235), zaokrouhleni) & " ft (feet)"
        label_yard.Text = "Lenght: " & Round(Val(základní_jednotka_délka * 1.0936132983377078), zaokrouhleni) & " yd (yards)"
        label_km.Text = "Lenght: " & Round(Val(základní_jednotka_délka * 0.001), zaokrouhleni) & " km (kilometers)"
        label_mile.Text = "Lenght: " & Round(Val(základní_jednotka_délka * 0.00062137119223733392), zaokrouhleni) & " mile (miles)"
        'Úhel
        label_stupne_uhlu.Text = "Angle: " & Round(Val(základní_jednotka_uhel), zaokrouhleni) & " deg (degrees)"
        label_MRAD.Text = "Angle: " & Round(Val(základní_jednotka_uhel / 0.057296), zaokrouhleni) & " MRAD (miliradians)"
        label_MOA.Text = "Angle: " & Round(Val(základní_jednotka_uhel * 60), zaokrouhleni) & " MOA (minutes of angle)"
        'Energie
