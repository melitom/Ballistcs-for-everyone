    ...
    Private Sub zapis_vysledku()
        ...
        If Hlavní_okno.checkbox_metricke_jednotky.Checked = True Then
            If stranová_korekce_klikani < 0 Then
                If Hlavní_okno.Checkbox_14_MOA.Checked = True Then
                    label_korekce_klikáním_stranová.Text = "Scope correction: " & Math.Round(Val((stranová_korekce_klikani * (-1)) * 60), 2) & " MOA" & " (" & Math.Round(Val(((stranová_korekce_klikani * (-1)) * 60) * 4), 0) & " clicks) left"
                ElseIf Hlavní_okno.Checkbox_18_MOA.Checked = True Then
                    label_korekce_klikáním_stranová.Text = "Scope correction: " & Math.Round(Val((stranová_korekce_klikani * (-1)) * 60), 2) & " MOA" & " (" & Math.Round(Val(((stranová_korekce_klikani * (-1)) * 60) * 8), 0) & " clicks) left"
                ElseIf Hlavní_okno.Checkbox_Jednotky_MRAD.Checked = True Then
                    label_korekce_klikáním_stranová.Text = "Scope correction: " & Math.Round(Val((((stranová_korekce_klikani * (-1)) / (180 / Math.PI))) * 1000), 2) & " MRAD" & " (" & Math.Round(Val(((stranová_korekce_klikani * (-1)) / (180 / Math.PI)) * 1000), 2) * 10 & " clicks) left"
                End If

                label_korekce_prenasenim_stranová.Text = "Sights correction: " & Math.Round(Val(stranová_korekce_prenaseni * (-1)), 1) & " cm left"

            ElseIf stranová_korekce_klikani > 0 Then

                If Hlavní_okno.Checkbox_14_MOA.Checked = True Then
                    label_korekce_klikáním_stranová.Text = "Scope correction: " & Math.Round(Val(stranová_korekce_klikani * 60), 2) & " MOA" & " (" & Math.Round(Val((stranová_korekce_klikani * 60) * 4), 0) & " clicks) right"
                ElseIf Hlavní_okno.Checkbox_18_MOA.Checked = True Then
                    label_korekce_klikáním_stranová.Text = "Scope correction: " & Math.Round(Val(stranová_korekce_klikani * 60), 2) & " MOA" & " (" & Math.Round(Val((stranová_korekce_klikani * 60) * 8), 0) & " clicks) right"
                ElseIf Hlavní_okno.Checkbox_Jednotky_MRAD.Checked = True Then
                    label_korekce_klikáním_stranová.Text = "Scope ccorrection: " & Math.Round(Val(((stranová_korekce_klikani / (180 / Math.PI))) * 1000), 2) & " MRAD" & " (" & Math.Round(Val((stranová_korekce_klikani / (180 / Math.PI)) * 1000), 2) * 10 & " clicks) right"
                End If

                label_korekce_prenasenim_stranová.Text = "Sights correction: " & Math.Round(Val(stranová_korekce_prenaseni), 1) & " cm right"

            Else
                label_korekce_prenasenim_stranová.Text = "Sights correction: "
                label_korekce_klikáním_stranová.Text = "Scope correction: "
            End If

            If výšková_korekce_klikani <> 0 Or výšková_korekce_klikani <> Nothing Then

                If Hlavní_okno.Checkbox_14_MOA.Checked = True Then
                    label_korekce_klikáním_výšková.Text = "Scope correction: " & Math.Round(Val((výšková_korekce_klikani * (-1)) * 60), 2) & " MOA" & " (" & Math.Round(Val(((výšková_korekce_klikani * (-1)) * 60) * 4), 0) & " clicks)"
                ElseIf Hlavní_okno.Checkbox_18_MOA.Checked = True Then
                    label_korekce_klikáním_výšková.Text = "Scope correction: " & Math.Round(Val((výšková_korekce_klikani * (-1)) * 60), 2) & " MOA" & " (" & Math.Round(Val(((výšková_korekce_klikani * (-1)) * 60) * 8), 0) & " clicks)"
                ElseIf Hlavní_okno.Checkbox_Jednotky_MRAD.Checked = True Then
                    label_korekce_klikáním_výšková.Text = "Scope correction: " & Math.Round(Val((((výšková_korekce_klikani * (-1)) / (180 / Math.PI))) * 1000), 2) & " MRAD" & " (" & Math.Round(Val(((výšková_korekce_klikani * (-1)) / (180 / Math.PI)) * 1000), 2) * 10 & " clicks)"
                End If
                label_korekce_přenášením_výšková.Text = "Sights correction: " & Math.Round(Val(výšková_korekce_prenaseni * (-1)), 1) & " cm"

            Else
                label_korekce_přenášením_výšková.Text = "Sights correction: "
                label_korekce_klikáním_výšková.Text = "Scope correction: "
            End If
        ...
        Else
            ...
            If stranová_korekce_klikani < 0 Then
                ...
                label_korekce_prenasenim_stranová.Text = "Sights correction: " & Math.Round(Val((stranová_korekce_prenaseni * (-1)) / 2.54), 1) & " in left"
            ...
            ElseIf stranová_korekce_klikani > 0 Then
                ...
                ElseIf Hlavní_okno.Checkbox_18_MOA.Checked = True Then
                    label_korekce_klikáním_stranová.Text = "Scope correction: " & Math.Round(Val(stranová_korekce_klikani * 60), 2) & " MOA" & " (" & Math.Round(Val((stranová_korekce_klikani * 60) * 8), 0) & " clicks) right"
                ElseIf Hlavní_okno.Checkbox_Jednotky_MRAD.Checked = True Then
                    label_korekce_klikáním_stranová.Text = "Scope correction: " & Math.Round(Val(((stranová_korekce_klikani / (180 / Math.PI))) * 1000), 2) & " MRAD" & " (" & Math.Round(Val((stranová_korekce_klikani / (180 / Math.PI)) * 1000), 2) * 10 & " clicks) right"
                End If

                label_korekce_prenasenim_stranová.Text = "Sights correction: " & Math.Round(Val(stranová_korekce_prenaseni / 2.54), 1) & " in right"
            ...
            If výšková_korekce_klikani <> 0 Or výšková_korekce_klikani <> Nothing Then
                ...
                ElseIf Hlavní_okno.Checkbox_Jednotky_MRAD.Checked = True Then
                    label_korekce_klikáním_výšková.Text = "Scope correction: " & Math.Round(Val((((výšková_korekce_klikani * (-1)) / (180 / Math.PI))) * 1000), 2) & " MRAD" & " (" & Math.Round(Val(((výšková_korekce_klikani * (-1)) / (180 / Math.PI)) * 1000), 2) * 10 & " clicks)"
                End If
                label_korekce_přenášením_výšková.Text = "Sights correction: " & Math.Round(Val((výšková_korekce_prenaseni * (-1)) / 2.54), 1) & " in"
