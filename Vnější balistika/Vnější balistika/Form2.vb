...
Public Class Vlastnosti_Atmosféry
    ...
    Private Sub Vlastnosti_Atmosféry_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If My.Settings.hustota_vzduchu = 0 Then
            ...
            If combobox_hustota_vzduchu.Text = "kg/m³" Then
                Textbox_Hustota_vzduchu.Text = "1,218"
            Else
                Textbox_Hustota_vzduchu.Text = "0,076"
            End If
        ...
        Try
            ...
            If Checkbox_Standardní_atmosféra_ICAO.Checked = False Then
                ...
                Try
                    ...
                    End If
                Catch ex As Exception
                    MsgBox("Wrong or missing data about height above sea.", MsgBoxStyle.Exclamation)
                End Try
                If nadmořská_výška < 0 Or nadmořská_výška > 11000 Then
                    chyba = True
                    MsgBox("The height above sea cannot be greater than 11000m = 12029yd = 36089ft, or less than 0.", MsgBoxStyle.Exclamation)
                End If
    ...
    Private Sub výpočet_hustoty_atmosféry()
        Try
            If Checkbox_Standardní_atmosféra_ICAO.Checked = False Then
                hustota_vzduchu = (1 / 286.078708) * (101325 * (1 - (nadmořská_výška / 44308)) / (273.15 + teplota))
                If combobox_hustota_vzduchu.Text = "kg/m³" Then
